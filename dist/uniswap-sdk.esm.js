...
var Router = /*#__PURE__*/function () {
  ...
  Router.resolveRingRouterParameters = function resolveRingRouterParameters(tradeType, etherIn, etherOut, amountIn, amountOut, recipient, path, deadline) {
    ...
    if (tradeType === TradeType.EXACT_INPUT) {
      ...
      var _encodedInputs = Interface.getAbiCoder().encode(['address', 'uint256', 'uint256', 'bytes', 'bool', 'bool'], _inputs);
    ...
    var encodedInputs = Interface.getAbiCoder().encode(['address', 'uint256', 'uint256', 'bytes', 'bool', 'bool'], inputs);
    return {
      methodName: methodName,
